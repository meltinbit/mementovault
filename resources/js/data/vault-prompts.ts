...
export const VAULT_PROMPTS: VaultPrompt[] = [
    ...
    { category: 'Memory', prompt: 'Move the note about [topic] to the [name] collection', description: 'Moves a memory entry to another collection', scope: 'collection' },
    ...
    { category: 'Documents', prompt: 'Create a document with [description]', description: 'Creates a new document in the collection', scope: 'collection' },
    ...
    { category: 'Collections', prompt: 'Switch to the [name] collection', description: 'Changes active collection context', scope: 'general' },
