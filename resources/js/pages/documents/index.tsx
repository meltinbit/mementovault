            ...
            <div className="space-y-6 overflow-hidden p-4">
                <div>
                    <div className="flex items-center justify-between gap-2">
                        <h2 className="min-w-0 text-xl font-semibold tracking-tight">Documents</h2>
                ...
                {documents.data.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-16 text-center">
                        ...
                        <p className="mt-1 max-w-sm text-xs text-muted-foreground">
                            Documents are reference materials that AI retrieves on demand — specs, guides, notes. Assign them to collections.
                        </p>
