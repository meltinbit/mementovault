...
export default function CollectionEdit({ collection }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: collection.name, href: `/collections/${collection.id}/edit` },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                <Heading title="Edit Collection" description={collection.name} />
            ...
            <DeleteConfirmation
                ...
                description="This deletes the collection, system documents, and all API tokens."
            />
        </AppLayout>
    );
}
