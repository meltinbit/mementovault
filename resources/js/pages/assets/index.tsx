                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0">
                                    <Heading
                                        ...
                                        description={currentFolderId === 'root' ? 'Assets not in any folder.' : 'Files and media stored in your nucleus. AI sees the asset list and can serve download URLs when needed. Add descriptions so AI knows what each file contains. Example: logos, screenshots, PDFs, design mockups.'}
                                    />
